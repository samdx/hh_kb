...
![](media/image30.png) vì quá trình sẽ mất khoảng 20 -&gt; 30
phút (Tùy cấu hình nhanh chậm của từng máy).

![](media/image31.png)

.IMG.![](media/image32.png)./IMG.
...
TeamViewer.Setup.vi) và click đúp chuột vào file đó để
